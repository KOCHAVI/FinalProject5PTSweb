<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="CreateVehicle.aspx.cs" Inherits="CreateVehicle" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="u-align-center u-clearfix u-image u-section-1" id="carousel_cb7a" data-image-width="1197" data-image-height="598">
        ...
        <h1 class="u-hover-feature u-text u-text-body-alt-color u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1250" data-animation-delay="250">Create A Vehicle</h1>
        <table style="position:absolute; margin-left:auto; margin-right:auto; left: 0; right:0; text-align:right; background-color:rgba(255,255,255,0.3); border-spacing:15px 20px; border-radius:30px;">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="TBType" runat="server" BackColor="Transparent" Font-Size="20px" BorderWidth="0px" Width="95%" CssClass="TB"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:TextBox ID="TBCapacity" runat="server" BackColor="Transparent" Font-Size="20px" BorderWidth="0px" Width="90%"></asp:TextBox>
                    <asp:RegularExpressionValidator ID="viewRegularExpressionValidator" runat="server" ValidationExpression="[0-9]{1,50}" ControlToValidate="TBCapacity">*</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
        ...
        <table style="text-align:right; background-color:rgba(255,255,255,0.3); border-spacing:15px 20px; border-radius:30px;">
            ...
            <tr>
                <td style="border-width:0px; background-color:transparent">
                    <asp:Label ID="LBLName" runat="server" Text="Vehicle Name!" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="border-width:0px; background-color:transparent">
                    <asp:Label ID="LBLCapacity" runat="server" Text="Vehicle Capacity!" ForeColor="Green"></asp:Label>
                </td>
            </tr>
        </table>
