<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ProfileSettings.aspx.cs" Inherits="ProfileSettings" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="u-align-center u-clearfix u-image u-section-1" id="carousel_cb7a" data-image-width="1197" data-image-height="598">
        ...
        <h1 class="u-hover-feature u-text u-text-body-alt-color u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1250" data-animation-delay="250">Profile</h1>
        <table style="position:absolute; margin-left:auto; margin-right:auto; left: 0; right:0; text-align:right; background-color:rgba(255,255,255,0.3); border-spacing:15px 35px; border-radius:30px;">
              ...
              <tr>
                  <td>
                      <asp:TextBox ID="TBUname" runat="server" BackColor="Transparent" Font-Size="20px" BorderWidth="0px" Enabled="false"></asp:TextBox>
                  </td>
                  <td>
                      <asp:TextBox ID="TBPass" runat="server" BackColor="Transparent" Font-Size="20px" BorderWidth="0px" TextMode="Password"></asp:TextBox>
              ...
              <tr>
                  <td style="border-width:0px; background-color:transparent" colspan="2">
                      <asp:Button ID="BTNUpdate" runat="server" Text="Update Profile" OnClick="BTNUpdate_Click" BorderWidth="0px" CssClass="BTN"/>
                  </td>
              </tr>
          </table>
